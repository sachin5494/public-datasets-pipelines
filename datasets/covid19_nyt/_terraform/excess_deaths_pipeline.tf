...
resource "google_bigquery_table" "excess_deaths" {
...
output "bigquery_table-excess_deaths-table_id" {
  value = google_bigquery_table.excess_deaths.table_id
}

output "bigquery_table-excess_deaths-id" {
  value = google_bigquery_table.excess_deaths.id
}
